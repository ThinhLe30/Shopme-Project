...
public class Category {
	...
	@Column(name = "all_parent_ids", nullable = true, length = 256)
	...
	public static Category copyFull(Category category){
		...
		copyCategory.setHasChildern(category.getChildren().size() > 0);
		return copyCategory;
	}
	public static Category copyFull(Category category, String dash){
		Category copyCategory = copyFull(category);
		copyCategory.setName(dash);
		return copyCategory;
	}
